            ...
            child: Padding(
              ...
              child: StreamBuilder<List<SessionsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<SessionsRecord> columnSessionsRecordList =
                      snapshot.data!;

                  final columnSessionsRecord =
                      columnSessionsRecordList.isNotEmpty
                          ? columnSessionsRecordList.first
                          : null;
