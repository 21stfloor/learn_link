...
import 'student_sidebar_model.dart';
export 'student_sidebar_model.dart';

class StudentSidebarWidget extends StatefulWidget {
  const StudentSidebarWidget({super.key});

  @override
  State<StudentSidebarWidget> createState() => _StudentSidebarWidgetState();
}

class _StudentSidebarWidgetState extends State<StudentSidebarWidget>
    with TickerProviderStateMixin {
  late StudentSidebarModel _model;
