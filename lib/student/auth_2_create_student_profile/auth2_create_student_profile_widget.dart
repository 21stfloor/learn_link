...
import 'auth2_create_student_profile_model.dart';
export 'auth2_create_student_profile_model.dart';

class Auth2CreateStudentProfileWidget extends StatefulWidget {
  const Auth2CreateStudentProfileWidget({super.key});

  @override
  State<Auth2CreateStudentProfileWidget> createState() =>
      _Auth2CreateStudentProfileWidgetState();
}

class _Auth2CreateStudentProfileWidgetState
    extends State<Auth2CreateStudentProfileWidget>
    with TickerProviderStateMixin {
  late Auth2CreateStudentProfileModel _model;
