...
import 'teacher_refund_page_widget.dart' show TeacherRefundPageWidget;
...
class TeacherRefundPageModel extends FlutterFlowModel<TeacherRefundPageWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in teacherRefundPage widget.
