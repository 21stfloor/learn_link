...
import 'teacher_sidebar_model.dart';
export 'teacher_sidebar_model.dart';
          ...
          children: [
            ...
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  context.pushNamed('teacherMySchedulesPage');
                },
                child: Container(
                  width: double.infinity,
                  height: 50.0,
            ...
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  context.pushNamed('teacherAttendancePage');
                },
                child: Container(
                  width: double.infinity,
                  height: 50.0,
            ...
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  context.pushNamed('teacherRefundPage');
                },
                child: Container(
                  width: double.infinity,
                  height: 50.0,
