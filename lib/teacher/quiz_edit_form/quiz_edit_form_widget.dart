...
class QuizEditFormWidget extends StatefulWidget {
  const QuizEditFormWidget({
    super.key,
    required this.quizToEdit,
  });

  final QuizRecord? quizToEdit;

  @override
  State<QuizEditFormWidget> createState() => _QuizEditFormWidgetState();
}

class _QuizEditFormWidgetState extends State<QuizEditFormWidget> {
  late QuizEditFormModel _model;
                                                      ...
                                                      itemBuilder: (context,
                                                        ...
                                                        return wrapWithModel(
                                                          ...
                                                          child:
                                                              QuestionEntryWidget(
                                                            key: Key(
                                                              'Keyod4_${questionsRowsIndex.toString()}',
                                                            ),
                                                            question:
                                                                questionsRowsItem,
                                                          ),
                                ...
                                onPressed: () async {
                                  ...
                                  try {
                                    ...
                                    if ((_model.existingQuizCount! > 0) &&
                                      ...
                                      // Delete existing questions first before adding the updated questions
                                      _model.iterator = 0;
                                      setState(() {});
