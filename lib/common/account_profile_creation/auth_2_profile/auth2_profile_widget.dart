                      ...
                      children: [
                            ...
                            child: StreamBuilder<List<SubscriptionsRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<SubscriptionsRecord>
                                    rowSubscriptionsRecordList = snapshot.data!;

                                // Return an empty Container when the item does not exist.
                                if (snapshot.data!.isEmpty) {
                                  return Container();
                                }
                                final rowSubscriptionsRecord =
                                    rowSubscriptionsRecordList.isNotEmpty
                                        ? rowSubscriptionsRecordList.first
                                        : null;
                                return Row(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    Text(
                                      'Subscription active : ${dateTimeFormat('relative', rowSubscriptionsRecord?.date)}',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Readex Pro',
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              if (valueOrDefault(
                                ...
                                context.pushNamed('auth_2_EditStudentProfile');
                              } else {
                                context.pushNamed('auth_2_EditTeacherProfile');
                              }
                            },
                            child: Container(
                              width: double.infinity,
                        ...
                        if (valueOrDefault(currentUserDocument?.role, '') ==
                          ...
                          Padding(
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) =>
                                  StreamBuilder<List<SkillSurveyRecord>>(
                                stream: querySkillSurveyRecord(
                                  queryBuilder: (skillSurveyRecord) =>
                                      skillSurveyRecord.where(
                                    'user',
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<SkillSurveyRecord>
                                      listViewSkillSurveyRecordList =
                                      snapshot.data!;

                                  if (listViewSkillSurveyRecordList.isEmpty) {
                                    return Container(
                                      width: double.infinity,
                                      child: NoSkillSurveyWidget(),
                                    );
                                  }
                                  return ListView.builder(
                                    ...
                                    itemCount:
                                        listViewSkillSurveyRecordList.length,
                                    itemBuilder: (context, listViewIndex) {
                                      final listViewSkillSurveyRecord =
                                          listViewSkillSurveyRecordList[
                                              listViewIndex];
                                      return Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              listViewSkillSurveyRecord.subject,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                                            ...
                                            RatingBarIndicator(
                                              ...
                                              rating: listViewSkillSurveyRecord
                                                  .score
                                                  .toDouble(),
                                              unratedColor:
                                                  FlutterFlowTheme.of(context)
                              ...
                              builder: (context) =>
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<TeacherRatingsRecord>
                                      containerTeacherRatingsRecordList =
                                      snapshot.data!;
