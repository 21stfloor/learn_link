...
class AdminSubjectListWidget extends StatefulWidget {
  const AdminSubjectListWidget({super.key});

  @override
  State<AdminSubjectListWidget> createState() => _AdminSubjectListWidgetState();
}

class _AdminSubjectListWidgetState extends State<AdminSubjectListWidget> {
  late AdminSubjectListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminSubjectListModel());
                                  ...
                                  child: StreamBuilder<List<SubjectsRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount:
                                            listViewSubjectsRecordList.length,
