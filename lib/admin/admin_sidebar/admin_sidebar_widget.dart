...
import 'admin_sidebar_model.dart';
export 'admin_sidebar_model.dart';
          ...
          children: [
            ...
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  context.pushNamed('adminSubjectList');
                },
                child: Container(
                  width: double.infinity,
                  height: 50.0,
            ...
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  context.pushNamed('adminSubscriptions');
                },
                child: Container(
                  width: double.infinity,
                  height: 50.0,
            ...
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  context.pushNamed('adminPaymentHistory');
                },
                child: Container(
                  width: double.infinity,
                  height: 50.0,
            ...
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  context.pushNamed('adminSettingsPage');
                },
                child: Container(
                  width: double.infinity,
                  height: 50.0,
