...
class AdminTeacherListWidget extends StatefulWidget {
  const AdminTeacherListWidget({super.key});

  @override
  State<AdminTeacherListWidget> createState() => _AdminTeacherListWidgetState();
}

class _AdminTeacherListWidgetState extends State<AdminTeacherListWidget> {
  late AdminTeacherListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminTeacherListModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.allTeachers = await queryUsersRecordOnce(
        queryBuilder: (usersRecord) => usersRecord.where(
          'role',
          isEqualTo: FFAppConstants.userTypeTeacher,
        ),
      );
      _model.teachers = _model.allTeachers!.toList().cast<UsersRecord>();
      setState(() {});
    });
                              ...
                              Expanded(
                                child: TextFormField(
                                  ...
                                  onFieldSubmitted: (_) async {
                                    ...
                                    _model.teachers = _model.simpleSearchResults
                                        .toList()
                                        .cast<UsersRecord>();
                                    setState(() {});
                                  },
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount: teacherRows.length,
                                        itemBuilder:
                                            (context, teacherRowsIndex) {
                                          final teacherRowsItem =
                                              teacherRows[teacherRowsIndex];
                                          return Padding(
                                            padding:
